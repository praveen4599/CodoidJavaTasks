...
class Sample {
    void sample() {
        System.out.println("You should pay more than or equal to the half the amount as advance");
        System.out.println();
    }
}
...
class Sample1 extends Sample // override
{
    void display() {
        ...
        System.out.println("   ");
        System.out.println(
                " NEO Travels is car online platform that has transformed car travel in the country by bringing ease and convenience to millions of Indians who travel using cars.\n Founded in 2023, NEO Travels is part of India's Leading Travel Online Company. Company Founder is Praveen Raj  ");
        System.out.println("  ");
